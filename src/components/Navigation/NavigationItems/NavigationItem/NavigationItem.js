...
const navigationItem = props =>(
    <ul className={classes.NavigationItem}>
        <li>
            <NavLink
                to={props.link}
                exact={props.exact} /**receiving exact prop from parent so that
                it now can be false or true and thus exact is set in an automatic way                
                Adding "EXACT" keyword so that active class is only attached
