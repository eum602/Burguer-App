    ...
    render(){        
        return(
            <div>
                ...
                />
                <Route path={`${this.props.match.path}/contact-data`} component={ContactData}/> {/*Using this nested route to be executed 
                in sychorization with checkoutContinuedHandler */}
            </div>
        )
    }    
}
